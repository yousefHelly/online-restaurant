...
function PageHeaderWithoutLink({
  ...
  return (
    <div className='flex flex-col gap-5 md:gap-10 w-full my-2 md:my-5'>
    <div className='flex justify-start gap-2 items-center dark:text-stone-300'>
      <ChevronRightCircle onClick={()=>router.push(prevPage == ""? "/" : prevPage)} size={28} className='mt-1 md:mt-2 text-lighterText cursor-pointer transition duration-150 hover:text-main'/>
