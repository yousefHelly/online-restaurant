...
type Props = {
    ...
    setValue?:  UseFormSetValue<DishFormType | CategoryForm>
}
...
function DropZoneUpload<T>({setPreview, setValue}: Props) {
    ...
    return (
          <section>
            <div {...getRootProps({ className: 'bg-slate-100 dark:bg-stone-700 dark:text-stone-300 border border-dotted border-main flex flex-col gap-3 items-center justify-center p-5 cursor-pointer hover:bg-slate-200 transition duration-150'})}>
              <input {...getInputProps()} />
