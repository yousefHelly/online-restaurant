...
function FailedOrder({}: Props) {
  ...
  return (
    <div className='flex flex-col w-full col-span-full items-center justify-center gap-5 pb-8'>
        <h3 className='text-6xl font-bold font-header text-transparent bg-clip-text bg-gradient-to-t min-h-[70px] from-[#ED213A] to-[#93291E] dark:to-red-600 drop-shadow-md '>
        فشل تأكيد الطلبية!
        </h3>
        <Image
